...
const GetCurrentLocation = ({currentLocation}) => {
    ...
    useEffect(async() => {
        if(coordinates.lat&&coordinates.lng){
           const {data} =  await axios.get(`http://dataservice.accuweather.com/locations/v1/cities/geoposition/search?apikey=${apiKey}&q=${coordinates.lat}%2C${coordinates.lng}&language=en-us&details=true&toplevel=false`)
